...
This was primarily a learning project for me, as I wanted to gain a deeper understanding of deep learning algorithms. I ended up applying popular neural network architectures, including Convolutional Neural Networks (CNNs) and Long Short-Term Memory networks (LSTMs), within a Generative Adversarial Network (GAN) framework. The goal was to predict oil production rates, using a high-quality dataset I have (about 50 years of production history).
