...
On the last note, I shared the physics-based models of seismic generated by sediment transport as using seismic methods to track bedload transport is an active field of research recently. There are several limitation of applying either the Tsai et al. (2012) or Luong et al. (2024) models to estimate bedload flux, mainly due to a very high dimensional space of model parameters. Namely, there are more than 22 model parameters, some of that we need to have a very good constrains in order to obtain a reasonable inversion.
...
During the monsoon seasons, we chased flow events at a small channel, essentially we chased the rain and observed flash floods at a natural lab set up at the arroyo de los Pinos--a tributary of the Rio Grande. Our work during summer is to track the radar and looking the weather forecast; and every times we see signs indicating that it will likely to rain at our basin, we will rush ourself into a truck full of tools/equipments for measuring river flow and sediment transport. The fun thing about this is sometimes we were lucky to witness the raw, powerful nature of flowing water, sometimes we were unlucky and false alarm happened at about 50\% of the time!
