...
For a long time, people believed that if you have a set of rules and you know how things start, then you can predict what a physical system will do next. So the universe is like a big clock, everything just follow the rules and nothing is really random. If you know the rules, you know what happen. And it works pretty well. People used this idea to build the foundation for fluid and solid mechanics and many other fields too. They wrote down equations that can predict how fluids and solids behave, just by assuming matter is smooth and continuous (and these equations are still everywhere today).

But as humans looked deeper into the worlds of very small things, they began to see strange behaviors in this mechanical clockwork picture. Experiments showed that matter at very small scales does not really behave like a smooth thing anymore. For instance, matter is made of even smaller particles like electrons, protons, and neutrons, or even smaller sub-atomic particles. And particle sometimes behave like waves and waves sometimes behave like particles.
...
In this new picture, the world is not deterministic anymore like we used to think. Even if you know the wavefunction of a system perfectly, you still cannot say for sure what will happen. You can only talk about probability, like the chance of finding an electron somewhere around the nucleus. And this uncertainty is not because our instruments are bad or our measurement is not good enough. It is just how the small world is. So nature itself is full of uncertainty, and there is nothing we can do about it.
